...
| **ponytail-review** / **ponytail-audit** | Risky task / before submit / tree feels bloated |
| **pstack** `/how` | Gnarly module before coding |
| Matt **implement** | Settled ticket / locked design |
| Matt **tdd** | Pure calc / classifiers |
| Matt **research** | External facts (AFK research tickets) |
...
| **critic** / **multi-lens-review** / Matt **code-review** | I4 — pick **one** |
