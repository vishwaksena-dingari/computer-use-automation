...
| **Captcha / bot wall** | Local: `http://127.0.0.1:4173/apply-demo/fail-captcha/` (page text) or live boards | Outcome `form.CAPTCHA`; `--escalate` → HITL (no bypass) |
| **Closed job** | Local: `http://127.0.0.1:4173/apply-demo/fail-closed/` or page “no longer accepting applications” | Outcome `form.CLOSED` |
